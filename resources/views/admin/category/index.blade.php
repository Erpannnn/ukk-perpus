...
<div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="/tambah-category" class="btn btn-primary btn-sm">Tambah Category</a>
            </div>
        </div>
        <div class="card-body">
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                            ...
                                            style="width: 97.125px;">Nama Kategori</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                            colspan="1" aria-label="Office: activate to sort column ascending"
                                            style="width: 59.225px;">Action</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($category_data as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->name }}</td>
                                            <td><a href="/hapus-category/{{ $item->id }}" class="btn btn-danger">Hapus</a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
